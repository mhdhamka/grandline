...
[Launch Grand Line](https://grandlinearch.vercel.app/) · [Report Marine](https://github.com/mhdhamka/grandline/issues) · [Request Log Pose Patch](https://github.com/mhdhamka/grandline/issues)
...
**Grand Line** (偉大なる航路) is a fully interactive, manga panel inspired web app built for true pirates who want to track the road to Laugh Tale without getting wiped out by a Buster Call (オカダのバスターコール). It features custom manga dialogue speech bubbles (`MangaBubble`), dynamic island-to-island status trackers.
...
git clone https://github.com/mhdhamka/grandline.git
cd grandline
